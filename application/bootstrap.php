...
if (is_file(APPPATH.'vendor/autoload'.EXT))
{
	// Autoload composer libraries
	require APPPATH.'vendor/autoload'.EXT;
}
 ...
 */
Cookie::$salt = "dietfurriesarelovely";
/**
...
if (PHP_SAPI != 'cli') require_once(APPPATH .'route.php');
