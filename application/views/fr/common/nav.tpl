<a href="<!--{$url_lang}-->">Index</a> - <a href="<!--{$url_lang}-->page/apropos">À propos</a> - <a href="<!--{$url_lang}-->chapitre/ep1">Lire</a> - <a href="<!--{$url_lang}-->blog">Nouvelles</a> - <a href="<!--{$url_base}-->en">English</a> -
...
<a href="https://calc.news/@Juju" aria-label="Mastodon"><i class="fab fa-mastodon" aria-hidden="true"></i></a>
